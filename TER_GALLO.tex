...
{\normalfont\bfseries}{}{10pt}{\pgfornament[width=3em,ydelta=-5pt]{67} \space \LARGE}
\titleformat{\section}[display] { \normalfont\bfseries}{}{10pt}{\Large }
\titlespacing{\section}{5pt}{20pt plus 4pt minus 2pt}{15pt plus 2pt minus 2pt}
\titlespacing{\chapter}{5pt}{12pt plus 4pt minus 2pt}{25pt plus 2pt minus 2pt}
\begin{document}
...
\begin{proof}
	Soit $M \in O(n)$ alors la mesure définis pas $\omega(A)= \nu\Big( T\in O(n) \;;\; Tx\in A\Big)$ vérifie 
	\begin{equation*}
		\omega(MA)= \nu\Big( T\in O(n) \;;\; M^{T}Tx\in A\Big)=\nu\Big( T\in O(n) \;;\; Tx\in A\Big)=\omega(A)
	\end{equation*}
	L'unicité de la mesure de Haar nous permet de conclure que $\omega = \nu$ car $\omega(S^{n-1})=1$.
\end{proof}
\theorem{
